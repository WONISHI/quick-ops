          ...
          <>
            {isSearchingFolder && (
              <div className={`${styles['search-status-msg']} ${partialSearchResultCount > 0 ? styles['search-status-msg-inline'] : ''}`}>
                ...
                {partialSearchResultCount > 0 ? `已找到 ${partialSearchResultCount} 项，继续检索中...` : '正在高速检索中...'}
              </div>
            )}
            ...
            {folderSearchError ? (
              ...
              folderSearchResults.length === 0 && folderSearchQuery ? (
                isSearchingFolder ? null : <div className={styles['search-empty-msg']}>没有找到符合条件的代码内容</div>
              ...
              isSearchingFolder ? null : <div className={styles['search-empty-msg']}>没有找到匹配的文件或文件夹</div>
            ) : (
              <ul>
