                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        ...
                        <div
                            ...
                            style={{
                                ...
                                fontSize: '11px', opacity: 0.8, cursor: 'pointer',
                        ...
                        >
                            <i className="codicon codicon-git-branch" style={{ fontSize: '12px' }} />
                            <span>{selectedGraphFilter}</span>
