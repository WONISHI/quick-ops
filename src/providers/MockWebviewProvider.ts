      ...
      <div class="panel-container">
        ...
        <div class="tab-content">
            <div id="pane-mock" class="tab-pane active">
                ...
                <textarea id="mockTemplate" style="height: 180px; margin-top:12px; font-family: var(--vscode-editor-font-family, monospace);" title="可直接编辑此处的 Mock.js 模板代码"></textarea>
            </div>
        ...
        <div id="previewArea" style="margin-top:10px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                ...
                <button onclick="simulate()" class="btn-icon-only" title="重新执行 Mock 生成预览结果"><i class="fa-solid fa-arrows-rotate"></i></button>
            </div>
